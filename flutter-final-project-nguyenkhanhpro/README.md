...
### clone repository
```bash 
git clone https://github.com/HUMG-IT/flutter-final-project-nguyenkhanhpro.git
cd flutter-final-project-nguyenkhanhpro
```
### Backend (Dart)
```bash
cd backend
...
## 8. Báo cáo nhanh quá trình thực hiện
...
## 9. Hướng dẫn demo nhanh cho giám khảo
...
## 10. Tự đánh giá điểm: **10/10**
- Đáp ứng đầy đủ CRUD, quản lý trạng thái, UI/UX trơn tru.
- Có các chức năng nâng cao như tìm kiếm, lọc theo tháng, thời gian, thu chi.
- Backend + CSDL SQLite FFI tích hợp hoàn chỉnh, xử lý lỗi rõ ràng.
- Kiểm thử tự động có sẵn, CI/CD GitHub Actions thiết lập và pass.
- Giao diện thân thiện, có tóm tắt số dư, chia quỹ, lịch sử rõ ràng.
